...
public class FreedomFighters extends AppCompatActivity implements GridRecyclerAdapter.listItemClickListener {
    ArrayList<NationalistData> FightersList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_freedom_fighters2);
        ...
        gridRecylerView.setAdapter(new GridRecyclerAdapter(FreedomFighters.this,FightersList,FreedomFighters.this));
    }

    @Override
    public void onItemClick(int clickedItemPosition) {
        NationalistData clickedItem=FightersList.get(clickedItemPosition);
        Intent wikiIntent=new Intent(FreedomFighters.this,Nationalistwiki.class);
