...
public class QuotesActivity extends AppCompatActivity implements QuotesAdapter.listItemClickListener {
...
//    int flipperIndex=-1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new SlidingImagesAdapter(QuotesActivity.this, QuotesList));
        ...
        quotesRecyclerView.setLayoutManager(new LinearLayoutManager(QuotesActivity.this));
        quotesRecyclerView.setAdapter(new QuotesAdapter(QuotesActivity.this, QuotesList, QuotesActivity.this));
