        ...
        if(!bundle.isEmpty())
        {
            if(bundle.containsKey("LauncherCategoryKey"))
            {
                if(bundle.getString("LauncherCategoryKey").equals("Param Vir Chakra"))
                {
                    ...
                    recipientsList.add(new NationalistData("Nirmal Jit Singh Sekhon","http://www.defenceacademy.in/wp-content/uploads/2017/08/nirmaljitsinghsekhononlyindianairforceofficertowinparamvirchakra652x4001_1439989237-278x365.jpg","https://en.wikipedia.org/wiki/Nirmal_Jit_Singh_Sekhon"));
                    ...
                    recipientsList.add(new NationalistData("Bana Singh","http://gallantryawards.gov.in/sites/default/files/styles/awardee_img/public/sites/default/files/66_1.jpg?itok=r8SpYXsz","https://en.wikipedia.org/wiki/Bana_Singh"));
                    recipientsList.add(new NationalistData("Ramaswamy Parameshwaran","http://gallantryawards.gov.in/sites/default/files/styles/awardee_img/public/sites/default/files/36_2.jpg?itok=q0JaLgg1","https://en.wikipedia.org/wiki/Ramaswamy_Parameshwaran"));
                ...
                else
                {
                    ...
                    recipientsList.add(new NationalistData("Bachittar Singh","http://gallantryawards.gov.in/sites/default/files/styles/awardee_img/public/sites/default/files/1_2.jpg?itok=6Dxtp4J3","https://www.honourpoint.in/profile/havaldar-bachittar-singh-ac/"));
