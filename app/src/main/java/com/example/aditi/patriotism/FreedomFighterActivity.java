...
public class FreedomFighterActivity extends AppCompatActivity implements GridRecyclerAdapter.listItemClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_freedom_fighter);
        ...
        RecyclerView gridRecylerView=findViewById(R.id.freedom_fighters_recycler_view);
        gridRecylerView.setLayoutManager(new GridLayoutManager(this,2));
        gridRecylerView.setAdapter(new GridRecyclerAdapter(FreedomFighterActivity.this,FightersList,FreedomFighterActivity.this));
    }

        @Override
        public void onItemClick(int clickedItemPosition) {
            NationalistData clickedItem=FightersList.get(clickedItemPosition);
            Intent wikiIntent=new Intent(FreedomFighterActivity.this,NationalistWiki.class);
