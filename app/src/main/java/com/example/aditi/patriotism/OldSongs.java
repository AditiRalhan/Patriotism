...
public class OldSongs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_old_songs);
        ...
        arrayList.add(new Music("Maa Tujhae Salam", "A. R. Rahman", R.raw.maatujhaesalam));
        arrayList.add(new Music("Mere Pyare Watan", "Manna Dey", R.raw.kabuliwalaayemerepyarewatankabuliwala));
        arrayList.add(new Music("Sandesi Atae Hae", "Sonu Nigam", R.raw.sandeseataehae));
